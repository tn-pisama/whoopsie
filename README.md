...
Manual test rhythm for verifying that AI builders (Lovable, Replit, Bolt, v0) keep producing working installs as their underlying AI behavior drifts. Run before every SDK release. See [docs/PLATFORM_TESTING.md](./docs/PLATFORM_TESTING.md).
